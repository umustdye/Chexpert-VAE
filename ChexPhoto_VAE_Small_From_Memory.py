...
for t in range(epochs):
    ...
    kl_div_graph.append(model.kl_div)
    loss_before_graph.append(model.loss_before)
    gamma_graph.append(model.gamma)
'''
    if(t == 25):
        torch.save(model.state_dict(), "model_25ep.pt")
    if(t == 50):
        torch.save(model.state_dict(), "model_50ep.pt")
    if(t == 75):
...
with open('loss_after.txt', 'w') as filehandle:
	for i in loss_graph:
		filehandle.write(str(i).item() + '\n')
with open('kl_div.txt', 'w') as filehandle:
        for i in kl_div_graph:
                filehandle.write(str(i).item() + '\n')
with open('gamma.txt', 'w') as filehandle:
        for i in gamma_graph:
                filehandle.write(str(i).item() + '\n')
with open('loss_before.txt', 'w') as filehandle:
...
plt.title("Loss After KL Divervence")
plt.plot(loss_graph)
##plt.show()
plt.savefig("loss_after.png")
...
plt.title("Loss Before KL Divergence")
plt.plot(loss_before_graph)
#plt.show()
plt.savefig("loss_before.png")
